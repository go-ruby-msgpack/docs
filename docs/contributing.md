...
Contributions are welcome. `go-ruby-msgpack/msgpack` is built to a small set of
...
The library is in [`github.com/go-ruby-msgpack/msgpack`](https://github.com/go-ruby-msgpack/msgpack).
This documentation site is in [`github.com/go-ruby-msgpack/docs`](https://github.com/go-ruby-msgpack/docs).
