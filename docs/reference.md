...
The public API lives at the module root (`github.com/go-ruby-msgpack/msgpack`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `msgpack`, while the surface follows
...
```go
import "github.com/go-ruby-msgpack/msgpack"
```
...
- **[pkg.go.dev/github.com/go-ruby-msgpack/msgpack](https://pkg.go.dev/github.com/go-ruby-msgpack/msgpack)**

The module's [README](https://github.com/go-ruby-msgpack/msgpack#readme) carries worked
